<button type="button" class="primary-button" data-toggle="modal" data-target=".bs-example1-modal-lg">
	Login/Signup
</button>
<div class="modal fade bs-example1-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-lg">
		<div style="background-image: url('assets/banner.png');" class="modal-content">
			<div class="container">
